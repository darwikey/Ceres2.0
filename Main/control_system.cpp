...
{
	ausbee_pid_init(&(am.pid_distance), 0.1, 0.0, 0.1);
	ausbee_pid_init(&(am.pid_angle), 0.2, 0.0, 0.2);
	...
	ausbee_cs_set_measure_fetcher(&(am.csm_distance), measureDistanceMm);
	ausbee_cs_set_measure_fetcher(&(am.csm_angle), measureAngleRad);
