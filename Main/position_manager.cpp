...
void position_update()
{
  ...
  int32_t new_right_enc = -encoder2.calcPosn();
	...
	int16_t left_enc_diff = pm.left_encoder - new_left_enc;
	int16_t right_enc_diff = pm.right_encoder - new_right_enc;

	pm.left_encoder = new_left_enc;
	pm.right_encoder = new_right_enc;
